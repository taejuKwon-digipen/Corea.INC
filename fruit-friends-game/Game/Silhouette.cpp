...
{
	double X = doodle::get_mouse_x(), Y = doodle::get_mouse_y();
	...
	if (doodle::MouseIsPressed == true && X < 10)
	{
...
void Silhouette::Draw(int stageNumb)
{
	...
	{
		silPtr[i]->Draw(math::TranslateMatrix(GetCurrApp(currStage)[i].pos));
	}

	if (showApp0 == true)
	{
		GetCurrApp(currStage)[0].App->Draw(math::TranslateMatrix(math::ivec2{ 240, 40 }));
		showApp1 = false;
		showApp2 = false;
		showApp3 = false;
	...
	if (showApp1 == true)
	{
		GetCurrApp(currStage)[1].App->Draw(math::TranslateMatrix(math::ivec2{ 240, 40 }));
		showApp0 = false;
		showApp2 = false;
		showApp3 = false;
		if (setComplelte == true)
	...
	if (showApp2 == true)
	{
		GetCurrApp(currStage)[2].App->Draw(math::TranslateMatrix(math::ivec2{ 240, 40 }));
		showApp0 = false;
		showApp1 = false;
		showApp3 = false;
		if (setComplelte == true)
	...
	if (showApp3 == true)
	{
		GetCurrApp(currStage)[3].App->Draw(math::TranslateMatrix(math::ivec2{ 240, 40 }));
		showApp0 = false;
		showApp1 = false;
		showApp2 = false;
		if (setComplelte == true)
	...
	{
		heartPtr[i]->Draw(math::TranslateMatrix{ math::ivec2{50 + i * 50, 710} });
	}
}
...
void Silhouette::checkAnswerHelper(bool whichOne, math::irect2 area, math::irect2 n0, math::irect2 n1, math::irect2 n2) // I could fix this by using initializer list
{
	...
	if (whichOne == true)
	{
		...
		{
			stampN->Draw(math::TranslateMatrix(math::ivec2{ area.Left() + 5, area.Bottom() + 3 }));
			if (doodle::MouseIsPressed == true) {
				sfx.STAMP.play();
				stamp->Draw(math::TranslateMatrix(math::ivec2{ area.Left() + 5, area.Bottom() + 3 }));
		...
		{
			stampN->Draw(math::TranslateMatrix(math::ivec2{ n0.Left() + 5, n0.Bottom() + 3 }));
			if (doodle::MouseIsPressed == true) {
				sfx.STAMP.play();
				stamp->Draw(math::TranslateMatrix(math::ivec2{ n0.Left() + 5, n0.Bottom() + 3 }));
		...
		{
			stampN->Draw(math::TranslateMatrix(math::ivec2{ n1.Left() + 5, n1.Bottom() + 3 }));
			if (doodle::MouseIsPressed == true) {
				sfx.STAMP.play();
				stamp->Draw(math::TranslateMatrix(math::ivec2{ n1.Left() + 5, n1.Bottom() + 3 }));
				AnswerBoolVec.push_back(false);
				setComplelte = true;
			}
		}
		...
		{
			stampN->Draw(math::TranslateMatrix(math::ivec2{ n2.Left() + 5, n2.Bottom() + 3 }));
			if (doodle::MouseIsPressed == true) {
				sfx.STAMP.play();
				stamp->Draw(math::TranslateMatrix(math::ivec2{ n2.Left() + 5, n2.Bottom() + 3 }));
				AnswerBoolVec.push_back(false);
				setComplelte = true;
			}
		}
