...
Hero::Hero(glm::vec2 startPos) : //add key for moving abd hero position vector
GameObject(heroPos),
rightKey(InputKey::KeyboardButtons::Right),
leftKey(InputKey::KeyboardButtons::Left),
jumpKey(InputKey::KeyboardButtons::Up),
heroPos(startPos),
drawHero(true)
{
	AddGOComponent(new coconut::Sprite("assets/heroine.spt", this));
...
void Hero::Draw(coconut::math::TransformMatrix displayMatrix)
{
	if (drawHero == true)
	{
