...
void Score::Draw(glm::ivec2 location) {
	scoreTexture.Draw(coconut::math::TranslateMatrix(location - glm::ivec2{ 0, scoreTexture.GetSize().y }));
}
...
void Boring::Draw(glm::ivec2 location) {
	boredTexture.Draw(coconut::math::TranslateMatrix(location - glm::ivec2{ 0, boredTexture.GetSize().y }));
}
...
void Doupting::Draw(glm::ivec2 location) {
	douptTexture.Draw(coconut::math::TranslateMatrix(location - glm::ivec2{ 0, douptTexture.GetSize().y }));
}
...
void Tired::Draw(glm::ivec2 location) {
	tiredTexture.Draw(coconut::math::TranslateMatrix(location - glm::ivec2{ 0, tiredTexture.GetSize().y }));
}
